  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-AAsecondary"> Front-End Development</span>, I have
        a keen eye for detail and <br className="2xl:block hidden" />a strong
        ability to transform designs to{" "}
        <span className="text-AAsecondary">Pixel-Perfectly.</span> My current
        area of focus is in the{" "}
        <span className="text-AAsecondary">React, Vue, Angular</span>,
        <br className="2xl:block hidden" /> where I actively engage in
        developing and designing immersive{" "}
        <span className="text-AAsecondary">user-friendly </span> and{" "}
        <span className="text-AAsecondary">responsive</span> applications. */}
        ...
        I&apos;m a{" "}
        <span className="text-AAsecondary">Full Stack Engineer </span>

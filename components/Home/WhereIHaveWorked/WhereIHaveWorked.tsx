...
import Accelex from "./Descriptions/Accelex";
import Paddle1 from "./Descriptions/Paddle1";
import Paddle2 from "./Descriptions/Paddle2";
import Accenture from "./Descriptions/Accenture";
export default function WhereIHaveWorked() {
  ...
  const [DescriptionJob, setDescriptionJob] = React.useState("Senior Full Stack Engineer");
  return (
      ...
      <div className="flex flex-col md:order-2 order-1 space-y-1 w-24 sm:w-full">
        <div className="flex flex-col sm:flex-row md:flex-col">
          <CompanyButton
            ...
            CompanyName="Accelex Technology"
            BarPosition={-1}
            BarAvobePosition={0}
            DescriptionJob="Senior Full Stack Engineer"

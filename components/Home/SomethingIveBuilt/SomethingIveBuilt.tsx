          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            <div className="absolute w-full h-full bg-opacity-70 z-0">
              <div className="relative w-full h-full">
                ...
                <Img
                  src={"https://www.doctorbuddyapp.com/img/TopBackground.png/"}
                  alt={"DoctorBuddy"}
            ...
            >
              ...
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left md:text-right ">
                  ...
                  <br />
                  At <span className="text-AAsecondary">Paddle</span>, I played
                  a crucial role in developing the frontend and backend of this
                  project using{" "}
        ...
        >
          ...
          >
           ...
           transition-opacity opacity-50 hover:opacity-0 hover:cursor-pointer duration-300"
              ...
              <Img
                src={
                  "https://images.prismic.io/paddle/c5cbf217-2bee-471c-8e78-3c8a9b8665a9_hero-billing.png?auto=compress%2Cformat&rect=0%2C0%2C2880%2C1148&w=1920&fit=max"
                }
                alt={"Project Screen shot"}
                className={`w-full rounded h-full `}
              />
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            <div className="absolute w-full h-full bg-opacity-70 z-0 md:order-2">
              <div className="relative w-full h-full">
                ...
                <div className="absolute w-full h-full bg-AAprimary opacity-80 z-10"></div>
                <Img
                  src={"https://images.prismic.io/paddle/c5cbf217-2bee-471c-8e78-3c8a9b8665a9_hero-billing.png?auto=compress%2Cformat&rect=0%2C0%2C2880%2C1148&w=1920&fit=max"}
                  alt={"Project Screen shot"}
                  className={`w-full h-full`}
                />
              </div>
            ...
            >
              ...
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left ">
                  ...
                  <span className="text-AAsecondary"> AI avatar</span>{" "}
                  generation project. It transforms your selfies into
                  captivating and personalized portraits with Mava&apos;s
                  AI-powered platform. My role was front-end development, I
                  developed it{" "}
                  <span className="text-AAsecondary">from scratch </span>
                  using{" "}
                  <span className="text-AAsecondary">
                    React, Redux, and Tailwind CSS
                  </span>
                  , and implemented a{" "}
                  <span className="text-AAsecondary">fully responsive</span>{" "}
